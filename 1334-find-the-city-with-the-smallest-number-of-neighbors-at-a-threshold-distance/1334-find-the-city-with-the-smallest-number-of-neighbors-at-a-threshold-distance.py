class Solution:
    def findTheCity(self, n: int, edges: list[list[int]], distanceThreshold: int) -> int:
        ...
        def get_number_of_neighbors_in_distance(source: int) -> int:
            ...
            # actually you can return len(visited) and with math there will be nothing wrong 
            # but actually we have len(visited) - 1 neighbors since we're not neighbor of ourselves
        ...
        for source in range(n):
            ...
            # we iterate source from smaller to bigger this ensures 
            # that we choose node with greater value if they have equal number of neighbors
